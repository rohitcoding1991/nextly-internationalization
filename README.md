...
The live version of this project is deployed and accessible [here](https://nextly-internationalization.vercel.app/).
...
```bash
git clone https://github.com/rohitcoding1991/nextly-internationalization
```
