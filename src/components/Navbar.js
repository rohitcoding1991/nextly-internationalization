      ...
      <nav className="w-full relative flex flex-wrap items-center justify-between py-4 px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        <div className="gap-3 nav__item mr-2 lg:flex ml-auto lg:ml-0 lg:order-2">
          ...
          <div className="hidden mr-3 lg:flex nav__item">
            <Link
              href="/"
              className="px-6 py-2 text-white bg-cyan-600 rounded-md md:ml-5"
            >
              {t("buttonText")}
            </Link>
          </div>
            ...
            <>
              ...
              <Disclosure.Panel className="flex flex-wrap w-full my-5 lg:hidden">
                <>
                  ...
                  <Link
                    href="/"
                    className="w-full px-6 py-2 mt-3 text-center text-white bg-cyan-600 rounded-md lg:ml-5"
                  >
                    Get Started
                  </Link>
                </>
          ...
          <ul className="items-center justify-end flex-1 pt-6 list-none lg:pt-0 lg:flex">
            {navigation.map((menu, index) => (
              <li className="mr-3 nav__item" key={index}>
                <Link
                  href="/"
                  className="inline-block px-4 py-2 text-lg font-normal text-gray-800 no-underline rounded-md dark:text-gray-200 hover:text-cyan-500 focus:text-cyan-500 focus:bg-cyan-100 focus:outline-none dark:focus:bg-gray-800"
                >
                  {menu}
                </Link>
              </li>
