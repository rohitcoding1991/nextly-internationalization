...
export const Hero = () => {
  ...
  // Handle dot click to navigate carousel
  ...
  return (
    <>
      ...
      {/* Brand Logos Section */}
      <BrandLogosCarousel t={t} />
    </>
  );
};

function BrandLogosCarousel({ t }) {
  const brandLogos = [
    { id: 1, name: "Amazon", component: <AmazonLogo />, className: "pt-2" },
    { id: 2, name: "Verizon", component: <VerizonLogo />, className: "" },
    { id: 3, name: "Microsoft", component: <MicrosoftLogo />, className: "" },
    { id: 4, name: "Netflix", component: <NetflixLogo />, className: "pt-1" },
    { id: 5, name: "Sony", component: <SonyLogo />, className: "pt-2" },
  ];

  return (
    <div className="w-full py-8 sm:py-10 lg:py-12 px-[10px]">
      <div className="flex flex-col justify-center">
        <div className="text-lg sm:text-xl text-center text-gray-700 dark:text-white mb-6 sm:mb-8">
          {t.rich("info", {
            span: (chunks) => (
        ...
        <div className="relative overflow-hidden w-full">
          <div className="flex animate-marquee hover:pause-marquee">
            ...
            {brandLogos.map((logo, idx) => (
              ...
              >
                <div
                  className={`text-gray-400 dark:text-gray-500 ${logo.className}`}
                >
                  {logo.component}
                </div>
              </div>
    ...
    >
      ...
      <div className="flex-1 w-full md:w-auto flex items-center">
        <div className="max-w-xl">
          ...
          <p className="text-base sm:text-lg md:text-lg lg:text-xl leading-relaxed text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 max-w-full break-words">
            {t(slide.description)}
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            <Button
              asChild
              size="lg"
              className="bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 text-white font-medium rounded-lg px-6 sm:px-8 py-3 sm:py-4 transition-all duration-300"
            >
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 font-medium rounded-lg px-6 sm:px-8 py-3 sm:py-4 flex items-center gap-2 transition-all duration-300"
              asChild
            >
              <a
                href="#"
      ...
      <div className="flex-1 w-full md:w-auto flex items-center justify-center">
        <div className="relative w-full max-w-sm md:max-w-md lg:max-w-lg">
          ...
          <Image
            ...
            height="500"
            alt={t(slide.title)}
            className="relative object-cover rounded-2xl shadow-2xl w-full h-auto"
            priority={index === 0}
          />
        </div>
      </div>
